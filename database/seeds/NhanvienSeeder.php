...
class NhanvienSeeder extends Seeder
{
    ...
    public function run(){
        ...
        array_push($list, [
            ...
            'nv_gioiTinh'  => true,
            'nv_email'     => "admin@zenishop.vn",
            'nv_ngaySinh'  => $today->format('Y-m-d H:i:s'),
            'nv_diaChi'    => "Quận Bình Thủy, TP Cần Thơ",
            'nv_dienThoai' => "0847349853",
            'nv_taoMoi'    => $today->format('Y-m-d H:i:s'),
            'nv_capNhat'   => $today->format('Y-m-d H:i:s'),
            'q_ten'         => 2
        ]);
